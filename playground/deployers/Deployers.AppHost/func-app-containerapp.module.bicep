...
param func_app_containerimage string

param func_app_identity_outputs_id string

param funcstorage6662c_outputs_blobendpoint string

param funcstorage6662c_outputs_queueendpoint string
...
param func_app_identity_outputs_clientid string
      ...
      containers: [
        {
          ...
          env: [
            ...
            }
            {
              ...
              value: funcstorage6662c_outputs_queueendpoint
            }
            {
            ...
            {
              name: 'foobarbaz__blobServiceUri'
              value: storage_outputs_blobendpoint
            }
            {
              name: 'foobarbaz__queueServiceUri'
              value: storage_outputs_queueendpoint
            }
            {
              name: 'Aspire__Azure__Storage__Blobs__foobarbaz__ServiceUri'
              value: storage_outputs_blobendpoint
            }
            {
            ...
            }
            {
              ...
              value: func_app_identity_outputs_clientid
            }
            {
