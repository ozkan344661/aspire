...
namespace Aspire.Hosting
{
    public static partial class AzureKubernetesEnvironmentExtensions
    {
        ...
        public static ApplicationModel.IResourceBuilder<Azure.AzureKubernetesEnvironmentResource> AddAzureKubernetesEnvironment(this IDistributedApplicationBuilder builder, string name) { throw null; }

        [AspireExport(Description = "Adds a node pool to the AKS cluster")]
        public static ApplicationModel.IResourceBuilder<Azure.Kubernetes.AksNodePoolResource> AddNodePool(this ApplicationModel.IResourceBuilder<Azure.AzureKubernetesEnvironmentResource> builder, string name, string vmSize = "Standard_D2s_v5", int minCount = 1, int maxCount = 3) { throw null; }

        [AspireExport(Description = "Configures the AKS environment to use a specific container registry")]
        public static ApplicationModel.IResourceBuilder<Azure.AzureKubernetesEnvironmentResource> WithContainerRegistry(this ApplicationModel.IResourceBuilder<Azure.AzureKubernetesEnvironmentResource> builder, ApplicationModel.IResourceBuilder<Azure.AzureContainerRegistryResource> registry) { throw null; }

        [AspireExport(Description = "Configures the AKS cluster to use a VNet subnet")]
        public static ApplicationModel.IResourceBuilder<Azure.AzureKubernetesEnvironmentResource> WithSubnet(this ApplicationModel.IResourceBuilder<Azure.AzureKubernetesEnvironmentResource> builder, ApplicationModel.IResourceBuilder<Azure.AzureSubnetResource> subnet) { throw null; }
        ...
        public static ApplicationModel.IResourceBuilder<Azure.AzureKubernetesEnvironmentResource> WithSystemNodePool(this ApplicationModel.IResourceBuilder<Azure.AzureKubernetesEnvironmentResource> builder, string vmSize = "Standard_D2s_v5", int minCount = 1, int maxCount = 3) { throw null; }

        [AspireExport(Description = "Enables workload identity on the AKS cluster")]
        public static ApplicationModel.IResourceBuilder<Azure.AzureKubernetesEnvironmentResource> WithWorkloadIdentity(this ApplicationModel.IResourceBuilder<Azure.AzureKubernetesEnvironmentResource> builder, bool enabled = true) { throw null; }
    }
}
