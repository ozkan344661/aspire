...
with create_builder() as builder:
    ...
    project = builder.add_project("resource", ".", launch_profile_name="default")
    # addCSharpApp
    ...
    built_connection_string = builder.add_connection_string("connection-string", build=build_connection_string)
    env_connection_string = builder.add_connection_string("env-connection-string")
    expression_connection_string = builder.add_connection_string("expression-connection-string", expression=expr)
