...
void main() throws Exception {
        ...
        container.withUrlsCallback((urlsContext) -> { var _urlsResource = urlsContext.resource(); var urlsLog = urlsContext.log(); var urlsExecutionContext = urlsContext.executionContext(); var _urlsIsRunMode = urlsExecutionContext.isRunMode(); var callbackEndpoint = urlsContext.getEndpoint("http"); var urlsEditor = urlsContext.urls(); urlsLog.debug("URLs callback logger"); urlsEditor.add(ReferenceExpression.refExpr("https://%s", callbackEndpoint), null); urlsEditor.addForEndpoint(callbackEndpoint, "/details", "Details"); });
